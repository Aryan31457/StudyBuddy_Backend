...
SECRET_KEY = 'django-insecure-xmu=q9m8gz7u#9=(t(^2g(b_xxc25i!gts#!i8hbjo2ufzp9)k'
...
# Channels removed with Communities app
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'db.sqlite3', # You can change this to your preferred db name
